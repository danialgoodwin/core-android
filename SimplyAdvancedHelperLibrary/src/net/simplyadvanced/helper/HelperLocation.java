 ...
 *  
 *  This class requires the following in AndroidManfest.xml:
    <!-- Required for access to user location provided by GPS. -->
    <uses-permission android:name="android.permission.ACCESS_FINE_LOCATION" />
    
    <!-- Required for access to user location provided by network provider. -->
